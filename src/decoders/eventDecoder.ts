...
export function decodeEnhancedEvents(hex: string): SubstrateEvent[] {
  ...
  try {
    ...
    for (let i = 0; i < eventCount; i++) {
      ...
      // Map pallet indices to names (extend as needed)
      const palletNames: Record<number, string> = {
        ...
        84: 'contracts',
        85: 'nfts',
        // Custom chain pallets often start at higher indices
        100: 'customPallet100',
        101: 'customPallet101',
        // Add more as needed
      };
      
      // Map event indices to names (simplified, would need metadata for accuracy)
      const eventNames: Record<string, Record<number, string>> = {
        ...
        utility: {
          ...
          4: 'ItemFailed',
          5: 'DispatchedAs',
          // Higher indices for newer runtime versions
          6: 'Event6',
          7: 'Event7',
          8: 'Event8',
          9: 'Event9',
        ...
        identity: {
          ...
          1: 'IdentityCleared',
          2: 'IdentityKilled',
          3: 'JudgementRequested',
          4: 'JudgementUnrequested', 
          5: 'JudgementGiven',
          6: 'RegistrarAdded',
          7: 'SubIdentityAdded',
          8: 'SubIdentityRemoved',
          9: 'SubIdentityRevoked',
        },
        multisig: {
          0: 'NewMultisig',
          1: 'MultisigApproval',
        ...
        contracts: {
          ...
          6: 'CodeUpdated',
          7: 'CodeRemoved',
          // Higher indices for contract-specific events
          100: 'Event100',
          150: 'Event150',
          154: 'Event154',
        },
